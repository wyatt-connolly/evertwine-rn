...
export const mockMeetups: Meetup[] = [
  {
    ...
    description: "Join us for a peaceful morning yoga session in the beautiful Golden Gate Park. All levels welcome!",
    creatorId: "user2",
  ...
  },
  {
    ...
    description: "Connect with fellow tech professionals over drinks and appetizers. Great opportunity to expand your network!",
    creatorId: "user3",
  ...
  },
  {
    ...
    description: "Explore the vibrant street art and architecture of the Mission District through photography. Bring your camera!",
    creatorId: "user1",
...
export const mockEvents: Event[] = [
  {
    ...
    description: "Join us for the biggest food festival of the year! Featuring local chefs, food trucks, and live music.",
    organizerId: "user3",
  ...
  },
  {
    ...
    description: "A peaceful evening of yoga, meditation, and mindfulness in a beautiful outdoor setting.",
    organizerId: "user2",
...
export const mockPlaces: Place[] = [
  {
    ...
    description: "Artisanal coffee roastery with minimalist design and exceptional single-origin beans."
  },
  {
    id: "place2",
    ...
    description: "Popular neighborhood park with stunning city views, perfect for picnics and outdoor activities."
  }
];
...
export const mockPlaceReviews: PlaceReview[] = [
  {
    ...
    rating: 5,
    review: "Amazing coffee and great atmosphere! The baristas are knowledgeable and the space is perfect for working or meeting friends.",
  ...
  },
  {
    ...
    rating: 4,
    review: "Beautiful park with great views! Perfect for yoga sessions and picnics. Can get crowded on weekends though.",
...
export const mockNotifications: Notification[] = [
  ...
  },
  {
    ...
    message: "Your request to join Tech Networking Happy Hour has been accepted!",
