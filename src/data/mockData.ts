...
export const mockStatusUpdates: StatusUpdate[] = [
  {
    ...
    type: "joined_meetup",
    targetId: "meetup2",
    targetTitle: "Tech Networking Happy Hour",
    targetType: "meetup",
    targetImage: "https://images.unsplash.com/photo-1511632765486-a01980e01a18?w=800",
    createdAt: new Date(Date.now() - 30 * 60 * 1000), // 30 mins ago
    likes: ["user2", "user3"],
    comments: [
      {
  ...
  },
  {
    ...
    userName: "Maya Rodriguez",
    userAvatar: "https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=400",
    type: "joined_happy_hour",
    targetId: "hh1",
    targetTitle: "Wine & Cheese Tasting",
    targetType: "happy_hour",
    targetImage: "https://images.unsplash.com/photo-1506377247377-2a5b3b417ebb?w=400&h=300&fit=crop",
    createdAt: new Date(Date.now() - 45 * 60 * 1000), // 45 mins ago
  ...
  },
  {
    ...
    type: "joined_meetup",
    targetId: "meetup1",
    targetTitle: "Morning Yoga on the Beach",
    targetType: "meetup",
    targetImage: "https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=800",
    createdAt: new Date(Date.now() - 4 * 60 * 60 * 1000), // 4 hours ago
    likes: ["user2"],
    comments: [],
  },
  {
    ...
    userName: "Maya Rodriguez",
    userAvatar: "https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=400",
    type: "created_happy_hour",
    targetId: "hh2",
    targetTitle: "Craft Beer Happy Hour",
    targetType: "happy_hour",
    targetImage: "https://images.unsplash.com/photo-1608270586620-248524c67de9?w=400&h=300&fit=crop",
    createdAt: new Date(Date.now() - 6 * 60 * 60 * 1000), // 6 hours ago
    likes: ["user1", "user3", "user4", "user5"],
    comments: [
      {
  ...
  },
  {
    ...
    type: "joined_meetup",
    targetId: "meetup3",
    targetTitle: "Photography Walk - Mission Beach Boardwalk",
    targetType: "meetup",
    targetImage: "https://images.unsplash.com/photo-1441974231531-c6227db76b6e?w=800",
    createdAt: new Date(Date.now() - 8 * 60 * 60 * 1000), // 8 hours ago
    likes: ["user1", "user2"],
    comments: [],
  },
  {
    ...
    userId: "user5",
    userName: "Taylor Smith",
    userAvatar: "https://images.unsplash.com/photo-1494790108755-2616b612b786?w=400&h=400&fit=crop",
    type: "joined_happy_hour",
    targetId: "hh3",
    targetTitle: "Rooftop Cocktails & City Views",
    targetType: "happy_hour",
    targetImage: "https://images.unsplash.com/photo-1470337458703-46ad1756a187?w=400&h=300&fit=crop",
    createdAt: new Date(Date.now() - 12 * 60 * 60 * 1000), // 12 hours ago
    likes: ["user1", "user2", "user3", "user4"],
    comments: [
      {
        ...
        userName: "Alex Chen",
        userAvatar: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=400&h=400&fit=crop",
        message: "The views are amazing from there! 🌆",
...
export const getMockStatusUpdates = (limit?: number): StatusUpdate[] => {
  return limit ? mockStatusUpdates.slice(0, limit) : mockStatusUpdates;
};
